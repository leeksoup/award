 ...
 */
abstract class RevisionDeleteForm extends ConfirmFormBase implements EntityFormInterface {
  ...
  public function getQuestion() {
    return $this->t('Deleting revision of "@label"', ['@label' => $this->revision->label()]);
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    if ($this->revision->hasLinkTemplate('version-history')) {
      ...
      if ($remainingRevisions !== 0 && $versionHistoryUrl->access($this->currentUser())) {
