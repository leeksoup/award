...
final class VipUpgradePane extends CheckoutPaneBase implements ContainerFactoryPluginInterface {
  ...
  public function __construct(array $configuration, $plugin_id, $plugin_definition, CheckoutFlowInterface $checkout_flow, EntityTypeManagerInterface $entity_type_manager, private EntitlementManager $manager) {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition, ?CheckoutFlowInterface $checkout_flow = NULL): static {
    return new static($configuration, $plugin_id, $plugin_definition, $checkout_flow, $container->get('entity_type.manager'), $container->get('commerce_lms_entitlements.manager'));
  }
  ...
  public function buildPaneForm(array $pane_form, FormStateInterface $form_state, array &$complete_form): array {
    ...
    $pane_form['selected'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Add the VIP live-session upgrade'),
      ...
      '#default_value' => (bool) $this->order->getData('commerce_lms_vip_selected'),
    ];
    return $pane_form;
  }
  ...
  public function submitPaneForm(array &$pane_form, FormStateInterface $form_state, array &$complete_form): void {
    ...
    $this->order->setData('commerce_lms_vip_selected', !empty($values['selected']));
    $this->order->save();
  }
